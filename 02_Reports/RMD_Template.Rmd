...
```{r logo, echo = FALSE}
htmltools::img(src = knitr::image_uri("00_Style/logo_as.png"),
               alt = "logo",
...
source(here("01_Code", "00_General_Parameters.r"), encoding = "UTF-8")
```
...
```{r sess_info, eval = params$print_session_info, results='markup'}
